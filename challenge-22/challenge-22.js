  ...
  */
  function sum(){
    ...
    return Array.prototype.reduce.call( arguments,
      function( acumulated, value ){
        return Number(acumulated) + Number(value);
      }
    );
  ...
  */
  ...
  var numbers = justNumbers(userEntry).split(',');
  /*
