...
pessoa.andar = function(quantidadeMetros){
    pessoa.caminhouQuantosMetros = pessoa.caminhouQuantosMetros + quantidadeMetros;
    pessoa.andando = true;
}
...
*/
pessoa.nomeCompleto(); // Matheus Castro
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostraPeso(); //80
/*
Qual a altura da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostraAltura(); //180
...
*/
pessoa.caminhouQuantosMetros; //340
...
pessoa.apresentacao() //"Olá, eu sou o Matheus Castro, tenho 27 anos, 180, meu peso é 80 e, só hoje, eu já caminhei 340 metros"
```
